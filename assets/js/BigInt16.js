define([], function () {
    ...
    BigInt16.prototype.gt = function (n) {
        return this.compare(n) === 1
    };
    BigInt16.prototype.ge = function (n) {
        return this.compare(n) >= 0
    };
    BigInt16.prototype.lt = function (n) {
        return this.compare(n) === -1
    };
    BigInt16.prototype.le = function (n) {
        return this.compare(n) <= 0
    };
    BigInt16.prototype.eq = function (n) {
        return this.compare(n) === 0
    };
    BigInt16.prototype.ne = function (n) {
        return this.compare(n) !== 0
    };
